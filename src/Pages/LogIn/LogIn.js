    ...
    return (
      <div className="LOGIN_WRAP">
        <div id="TITLE_CONTAINER">
          {/* 정적생성영역 */}
          <div className="TITLE">Log in to Miniter</div>
        </div>
        ...
        <div id="LOGIN_INPUT_CONTAINER">
          ...
          <SmartInput className="SMART_INPUT" id="1" inputType="password" 
                      placeholder="Password" onChangeDataForParents={this.onChangeDataForParents}></SmartInput>
        </div>

        <div id="BUTTON_CONTAINER">
          {/* 정적생성영역 (추후 동적으로 생성되도록 수정 예정) */}
          <button id="LOGIN_COMPLETE" onClick={this.onCompleteClick}>LOG IN</button>
